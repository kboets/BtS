...
INSERT INTO `team` (`id`, `team_id`, `name`, `stadium_name`, `city`, `stadium_capacity`, `logo`, `league_id`) VALUES
  (547, 260, 'OH Leuven', 'King Power at Den Dreef Stadion', 'Heverlee', 12500, 'https://media.api-sports.io/football/teams/260.png', 4366),
  (548, 261, 'KVC Westerlo', 'Het Kuipje', 'Westerlo', 8035, 'https://media.api-sports.io/football/teams/261.png', 4366),
  (549, 266, 'KV Mechelen', 'AFAS-stadion Achter de Kazerne', 'Malines', 16715, 'https://media.api-sports.io/football/teams/266.png', 4366),
  (550, 554, 'Anderlecht', 'Lotto Park', 'Brussel', 28063, 'https://media.api-sports.io/football/teams/554.png', 4366),
  (551, 569, 'Club Brugge KV', 'Jan Breydelstadion', 'Brugge', 29062, 'https://media.api-sports.io/football/teams/569.png', 4366),
  (552, 600, 'Zulte Waregem', 'Elindus Arena', 'Waregem', 12300, 'https://media.api-sports.io/football/teams/600.png', 4366),
  (553, 624, 'Oostende', 'Diaz Arena', 'Oostende', 8432, 'https://media.api-sports.io/football/teams/624.png', 4366),
  (554, 631, 'Gent', 'GHELAMCO-arena', 'Gent', 20000, 'https://media.api-sports.io/football/teams/631.png', 4366),
  (555, 733, 'Standard Liege', 'Stade Maurice Dufrasne', 'Luik', 27670, 'https://media.api-sports.io/football/teams/733.png', 4366),
  (556, 734, 'Kortrijk', 'Guldensporenstadion', 'Kortrijk', 9399, 'https://media.api-sports.io/football/teams/734.png', 4366),
  (557, 735, 'St. Truiden', 'Stadion Stayen', 'St.-Trond', 14600, 'https://media.api-sports.io/football/teams/735.png', 4366),
  (558, 736, 'Charleroi', 'Stade du Pays de Charleroi', 'Charleroi', 14967, 'https://media.api-sports.io/football/teams/736.png', 4366),
  (559, 739, 'AS Eupen', 'Stadion am Kehrweg', 'Eupen', 8363, 'https://media.api-sports.io/football/teams/739.png', 4366),
  (560, 740, 'Antwerp', 'Bosuilstadion', 'Deurne', 23057, 'https://media.api-sports.io/football/teams/740.png', 4366),
  (561, 741, 'Cercle Brugge', 'Jan Breydelstadion', 'Brugge', 29062, 'https://media.api-sports.io/football/teams/741.png', 4366),
  (562, 742, 'Genk', 'Cegeka Arena', 'Genk', 24956, 'https://media.api-sports.io/football/teams/742.png', 4366),
  (563, 1393, 'Union St. Gilloise', 'Stade Joseph Mariën', 'Brussels', 9400, 'https://media.api-sports.io/football/teams/1393.png', 4366),
  (564, 10244, 'Seraing United', 'Stade du Pairay', 'Seraing', 14326, 'https://media.api-sports.io/football/teams/10244.png', 4366);
